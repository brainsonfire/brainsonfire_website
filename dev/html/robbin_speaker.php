...
<head>
    ...
    <title>Brains on Fire | Speaking | Robbin Phillips</title>
		...
		<div class="inner-wrap">
			...
			<main id="main" class="speaker-detail inner-pages">
				...
				<section id="blockquote" class="speakers">
					<div class="row">
						<blockquote>“Robbin's presentation was incredibly inspiring and left attendees thinking big. She did an excellent job setting up stories, building a case for how to engage with an audience, and how to inspire them to work as natural brand ambassadors.”</blockquote>
						<cite>Megan Merry<br>IABC Omaha</cite>
					</div>
					<div class="submit-application">
						<a class="button btn-blue" href="speaking.php#form">book <span>Robbin Phillips</span> now</a>
					</div>
				</section>
