...
<head>
    ...
    <title>Brains on Fire | Greg Cordell</title>
		...
		<div class="inner-wrap">
			...
			<main id="main" class="individual-detail">
				...
				<div class="direction-nav top">
					<div class="row">
						<ul>
							<li><a class="previous" href="robbin_phillips.php"><span>previous individual</span></a></li>
							<li><a class="center" href="individual.php"><span>back to all people</span></a></li>
							<li><a class="next" href="greg_ramsey.php"><span>next individual</span></a></li>
						</ul>
					</div>
				</div>
				...
				<section class="mega-holder">
					...
					<div class="mega-banner">
						<div class="photo-container">
							<div class="holder">
								<img src="images/individuals/lobby-shots/cordell.png" alt="Greg Cordell" class="cordell active">
							</div>
							<div class="holder02">
								<img src="images/individuals/lobby-shots/cordell.png" alt="Greg Cordell" class="cordell active">
							</div>
					...
					<article class="people-post">
						<div class="row heading">
							<h1>Greg Cordell</h1>
							<em class="job-title">Chief Inspiration Officer</em>
						</div>
							...
							<div class="large-8 medium-8 small-12 columns">
								<div class="large-6 medium-12 small-12 columns">
									<ul class="arbitrary-facts">
										<li>University of South Carolina Grad</li>
										<li>Married with children</li>
										<li>White Male - nothing I can do about that now</li>
										<li>Prefers not to talk about himself, though he likes to talk</li>
									</ul>
