			...
			<main id="main" class="speaking">
				...
				<div id="speakers">
					<div class="row">
						<ul class="speakers-list">
							<li>
								<a href="#dummy">
									<img src="images/speaking/robbin.jpg" alt="">
									<span>Robbin Phillips</span>
								</a>
								<a href="#dummy" class="button btn-orange">learn more</a>
							</li>
							<li>
								<a href="#dummy">
									<img src="images/speaking/geno.jpg" alt="">
									<span>Geno Church</span>
								</a>
								<a href="#dummy" class="button btn-orange">learn more</a>
							</li>
							<li>
								<a href="#dummy">
									<img src="images/speaking/john.jpg" alt="">
							...
							<li>
								<a href="#dummy">
									<img src="images/speaking/greg.jpg" alt="">
									<span>Greg Cordell</span>
								</a>
								<a href="#dummy" class="button btn-orange">learn more</a>
							</li>
						</ul>
				...
				<section id="speaking-info">
					<div class="row">
						...
						<div class="large-4 columns audience">
							...
							<ul>
								...
								<li>C-level Executives for Fortune 500 Corporations</li>
							</ul>
						</div>
						...
						<form action="#">
							...
							<div class="row">
								<div class="large-12 columns">
									<label>
										<span>Brief description of the event & link for registration (required)</span>
