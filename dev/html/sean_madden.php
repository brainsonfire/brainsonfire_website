...
<head>
    ...
    <title>Brains on Fire | Sean Madden</title>
		...
		<div class="inner-wrap">
			...
			<main id="main" class="individual-detail">
				...
				<div class="direction-nav top">
					<div class="row">
						<ul>
							<li><a class="previous" href="sarah_leitner.php"><span>previous individual</span></a></li>
							<li><a class="center" href="individual.php"><span>back to all people</span></a></li>
							<li><a class="next" href="shannon_kohn.php"><span>next individual</span></a></li>
						</ul>
					</div>
				</div>
