				...
				<div class="row">
					...
					<form id="form5" name="form5" class="wufoo rightLabel page form-contact" accept-charset="UTF-8" autocomplete="off" enctype="multipart/form-data" method="post" novalidate action="https://firesession.wufoo.com/forms/s19td7he1o23xgi/#public">
						<ul>
							...
							<li id="foli10" class="phone notranslate row">
								<span><input id="Field10" name="Field10" type="tel" class="field text" value="" size="3" maxlength="3" tabindex="4" /></span>
								<span class="dash">-</span>
								<!-- <span class="symbol">-</span> -->
								<span><input id="Field10-1" name="Field10-1" type="tel" class="field text" value="" size="3" maxlength="3" tabindex="5" /></span>
								<span class="dash">-</span>
								<!-- <span class="symbol">-</span> -->
								<span><input id="Field10-2" name="Field10-2" type="tel" class="field text" value="" size="4" maxlength="4" tabindex="6" /></span>
