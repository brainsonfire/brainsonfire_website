...
<head>
    ...
    <title>Brains on Fire | Emily Everhart</title>
		...
		<div class="inner-wrap">
			...
			<main id="main" class="individual-detail">
				...
				<div class="direction-nav top">
					<div class="row">
						<ul>
							<li><a class="previous" href="cathy_harrison.php"><span>previous individual</span></a></li>
							<li><a class="center" href="individual.php"><span>back to all people</span></a></li>
							<li><a class="next" href="jack_welch.php"><span>next individual</span></a></li>
						</ul>
					</div>
				</div>
