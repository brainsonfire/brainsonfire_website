...
<head>
    ...
    <title>Brains on Fire | Jack Welch</title>
		...
		<div class="inner-wrap">
			...
			<main id="main" class="individual-detail">
				...
				<div class="direction-nav top">
					<div class="row">
						<ul>
							<li><a class="previous" href="emily_everhart.php"><span>previous individual</span></a></li>
							<li><a class="center" href="individual.php"><span>back to all people</span></a></li>
							<li><a class="next" href="mary_susan_henderson.php"><span>next individual</span></a></li>
						</ul>
					</div>
				</div>
