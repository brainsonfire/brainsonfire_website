...
<head>
    ...
    <title>Brains on Fire | Robbin Phillips</title>
				...
				<section class="mega-holder">
					...
					<div class="mega-banner">
						<div class="photo-container">
							<div class="holder">
								<img src="images/individuals/lobby-shots/robbin.png" alt="Robbin Phillips" class="robbin active">
							</div>
							<div class="holder02">
								<img src="images/individuals/lobby-shots/robbin.png" alt="Robbin Phillips" class="robbin active">
							</div>
					...
					<article class="people-post">
						<div class="row heading">
							...
							<em class="job-title">Courageous President</em>
						</div>
						...
						<div class="row cols-holder">
							...
							<div class="meta large-4 medium-4 small-12 columns">
								...
								<div class="holder">
									<h3>Find Robbin Online:</h3>
									<ul class="social">
										<li><a href="http://www.linkedin.com/in/robbinphillips" class="linkedin">Linked In</a></li>
										<li><a href="https://twitter.com/robbinphillips" class="twitter">Twitter</a></li>
										<li><a href="https://www.facebook.com/therealrobbinphillips" class="facebook">Facebook</a></li>
									</ul>
								</div>
							</div>
							...
							<div class="large-8 medium-8 small-12 columns">
								<div class="large-6 medium-12 small-12 columns">
									<ul class="arbitrary-facts">
										<li>Arts Major</li>
										<li>Founder</li>
										<li>Evangelist of All Things Simple</li>
										<li>Boot Connoisseur</li>
									</ul>
