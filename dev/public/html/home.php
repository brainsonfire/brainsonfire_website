						...
						<div class="slideset">
							<div class="slide bighome">
								<div class="txt row">
									...
									<a href="work.php" class="button">we’ll teach you how</a>
									<a href="work.php" class="button">or build it with you</a>
								</div>
							</div>
						</div>
					</div>
				...
				<section id="checkpoint1" class="section-work">
					<div class="row">
						...
						<div class="btn-holder">
							<a class="btn-view" href="#dummy">View all of our case studies</a>
						</div>
					</div>
				</section>
